    ...
    <section className="w-full min-h-[calc(100vh-theme(spacing.14))] flex items-center relative overflow-hidden bg-background">
      ...
      <div className="container z-10 relative flex flex-col items-center">
        <div className="w-full max-w-3xl flex flex-col items-center text-center">
          ...
          <div className="w-full max-w-xl flex items-center gap-2 p-1.5 rounded-lg bg-card border shadow-sm mb-4">
            <Input 
              type="text" 
            ...
            />
            <Button size="lg" className="h-12 px-6 bg-primary text-primary-foreground hover:bg-primary/90 rounded-md">
              Criar Loja
