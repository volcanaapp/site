  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      <motion.h2
        ...
        className="text-3xl font-bold text-[#181817] mb-12"
      >
        Arquitetando sua Loja...
      </motion.h2>

      <svg width="300" height="200" viewBox="0 0 300 200" className="mb-12">
        <motion.rect
          x="10" y="10" width="280" height="40" rx="5"
          stroke="#181817" strokeWidth="2" fill="none"
      ...
      <div className="h-8 text-lg text-gray-500 font-mono">
